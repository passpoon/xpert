...
public interface MgAppCriticalValueRepository extends CrudRepository<MgAppCriticalValue, MgAppCriticalValuePK> {
    ...
    public Collection<MgAppCriticalValue> findAllByMonGroupIdAndAppResourceIdAndMetric_MeasurementId(Integer monitoringGroupId, Integer appResourceId, Integer measurementId);
